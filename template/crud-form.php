<div id="wp_employee_crud_plugin">
    ...
    <div class="hide_element add-employee-form">
        <div class="list-container_title">
            <h3>Add Employee</h3>
            <button id="btn_close_add_employee_form">close form</button>
        </div>
        <form action="javascript:void(0)" id="frm_add_employee" class="" enctype="multipart/form-data">
    ...
    <div class="hide_element edit-employee-form">

        <div class="list-container_title">
            <h3>Edit Employee</h3>
            <button id="btn_close_edit_employee_form">close form</button>
        </div>
        ...
        <form action="javascript:void(0)"  id="frm_edit_employee" enctype="multipart/form-data">
            ...
            <div>
                <img src="" alt="" id="edit_form_image" width="100" height="100">
            </div>
            <div class="form-group">
                <button id="btn_save_data" type="submit">Update Data</button>
            </div>
        </form>

    </div>
   
    <div class="list-container" id="employee_table">
        <div class="list-container_title">
